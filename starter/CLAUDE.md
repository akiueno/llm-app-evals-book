...
Preserve the code printed in the book. Closing spam is a web-only database update and must not call FastAPI or LangSmith. Chapter10 adds feedback on reply sending only.
